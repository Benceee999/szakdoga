            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <form action="?action=feltoltes" method="post" enctype="multipart/form-data">
                  ...
                  <form action="?action=changeuser" method="post" enctype="multipart/form-data">
                  <?php
                  echo '
                  
                  <div class="row mb-3">
                    <label for="felhnev" class="col-md-4 col-lg-3 col-form-label">Felhasználónév</label>
                    <div class="col-md-8 col-lg-9">
                      <input name="felhnev" type="text" class="form-control" id="felhnev" value="' . $_SESSION['felhnev'] . '">
                    </div>
                  </div>
                    ...
                    <div class="text-center">
                      <button type="submit" name="changeuser" class="btn btn-primary">Változtatások mentése</button>
                    </div>
              ...
              <div class="tab-pane fade pt-3" id="profile-change-password">
                ...
                <form action="?action=" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">Új jelszó</label>
                    <div class="col-md-8 col-lg-9">
                  ...
                  <div class="row mb-3">
                    <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Jelszó újra</label>
                    <div class="col-md-8 col-lg-9">
