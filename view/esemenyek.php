                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                <li class="nav-item">
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#ujesemeny">Új
                                        esemény felvétele</button>
                                </li>

                                <li class="nav-item">
                                    <button class="nav-link" data-bs-toggle="tab"
                                        data-bs-target="#korabbiesemeny">Korábbi események listája</button>
                                </li>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active ujesemeny" id="ujesemeny">
                                    ...
                                    <h5 class="card-title">Új esemény felvétele</h5>
